...
const nabhReimbursementController = require('../controllers/nabhReimbursementController');
...
// NABH Accreditation Fee Reimbursement
router.post('/nabh-reimbursement', protect, roleMiddleware('ayush_hospital'), ayushHospitalUpload.fields([
    { name: 'doc_nabh_certificate', maxCount: 1 },
    { name: 'doc_fee_receipt',      maxCount: 1 },
    { name: 'doc_bank_details',     maxCount: 1 },
    { name: 'doc_others',           maxCount: 1 },
]), nabhReimbursementController.submitReimbursement);
router.get('/nabh-reimbursement', protect, roleMiddleware('ayush_hospital'), nabhReimbursementController.getMyReimbursements);
