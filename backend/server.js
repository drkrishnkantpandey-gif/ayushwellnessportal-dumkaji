...
async function runWellnessCentreOperationalMigration() {
  try {
    await pool.query(`
      ...
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS registration_number VARCHAR(30) UNIQUE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS already_on_portal BOOLEAN DEFAULT FALSE;
      ...
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS offers_clinical BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS category VARCHAR(100);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS services_offered TEXT[];
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS doctor_appointed BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS doctor_name VARCHAR(255);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS doctor_qualification VARCHAR(255);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS doctor_qual_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS bcp_reg_number VARCHAR(100);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS bcp_reg_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS cea_reg_number VARCHAR(100);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS cea_valid_till DATE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS cea_reg_certificate TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS cea_registered BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS declaration_board BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS declaration_signboard BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS clinical_affidavit TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS reception_area_sqft NUMERIC(10,2);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS waiting_capacity INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS consultation_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS incharge_name VARCHAR(255);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS incharge_mobile VARCHAR(20);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS emergency_centre_name VARCHAR(255);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS emergency_distance_m NUMERIC(10,2);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS offers_prakruti BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS website TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS service_charges_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS brochure_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS num_beds INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS kitchen_available BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS dosha_dietetics BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS parking_cars INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS cctv_supervised BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS abhyanga_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS vasti_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS post_therapy_waiting_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS medicine_dispensing_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS marma_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS para_surgical_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS kshar_sutra_ot INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS yoga_halls INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS meditation_halls INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS shatkarma_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS massage_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS enema_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS hydrotherapy_rooms INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS receptionist_count INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS sanitation_worker_count INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS mpw_count INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS cook_count INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS watchman_count INTEGER;
      ...
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS male_panchakarma_therapist INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS female_panchakarma_therapist INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS panchakarma_staff_bcp_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS yoga_instructor_count INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS yoga_instructor_qual_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS bnys_doctor_name VARCHAR(255);
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS bnys_reg_certificate TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS male_naturopathy_attendant INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS female_naturopathy_attendant INTEGER;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS naturopathy_staff_bcp_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS fee_deposited BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS fee_receipt_doc TEXT;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS all_declarations_accepted BOOLEAN DEFAULT FALSE;
      ALTER TABLE wellness_centre_registrations ADD COLUMN IF NOT EXISTS declaration_affidavit TEXT;
